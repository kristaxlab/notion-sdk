...
- [Interceptors](../contributing/architecture.md#interceptors) -- where exchange logging sits in the pipeline
- [Testing Guide](../contributing/testing-guide.md) -- using exchange files as test fixtures

...
Writes each request/response pair as JSON files to a directory. See [Exchange Recording](../advanced/exchange-recording.md).
...
- [Custom Interceptors](../advanced/custom-interceptors.md) -- writing custom interceptors

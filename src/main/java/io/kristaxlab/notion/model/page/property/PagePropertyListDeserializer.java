...
public class PagePropertyListDeserializer extends JsonDeserializer<PagePropertyList> {
  ...
  @Override
  public PagePropertyList deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    Class<? extends PagePropertyList> targetClass = switch (nestedType) {

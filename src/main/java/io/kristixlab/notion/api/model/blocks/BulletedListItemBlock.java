 ...
 *
 * <p>A bulleted list item is a block that displays content with a bullet point. It can contain rich
 * text content and supports nested child blocks to create hierarchical list structures.
 *
 * @author KristaxLab
 * @see Block
 * @see RichText

...
/**
 * Fallback attachment type for unknown or unsupported comment attachment types. Used when the API
 * returns an attachment type that is not yet supported by this SDK.
 */
@Data

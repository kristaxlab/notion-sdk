...
public class FileBlocksDeserializationTestBaseBlockDeserializationTest extends BaseBlockDeserializationTest {
    ...
    void testImage() {
        ...
        for (Block block : response.getResults()) {
            if ("22dc5b96-8ec4-805b-8f58-c15a5cc8fd80".equals(block.getId())) {
                ...
                assertFalse(img.isArchived());
                assertFalse(img.isInTrash());

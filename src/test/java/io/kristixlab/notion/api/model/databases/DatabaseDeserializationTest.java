...
/**
 * Unit test for Database deserialization from JSON.
 * Tests all database property types and their configurations.
 */
public class DatabaseDeserializationTest {
    ...
    static void init() throws Exception {
        ...
        InputStream is = DatabaseDeserializationTest.class
                .getClassLoader()
    ...
    void testBasicFields() {
        ...
        assertEquals("https://someurlweb.notion.site/24cc5b968ec4800aa809c7f6508f45f2", database.getPublicUrl());
    }
    ...
    void testMultiSelectProperty() {
        ...
        MultiSelectDatabaseProperty.SelectOption option1 = multiSelectProperty.getMultiSelect().getOptions().get(0);
    ...
    void testRelationProperties() {
        ...
        assertEquals("24cc5b96-8ec4-8087-aebc-f14c03858e6a", relationProperty.getRelation().getDatabaseId());
        ...
        assertEquals("notion sdk // test database", relationProperty.getRelation().getDualProperty().getSyncedPropertyName());
    ...
    void testFormulaProperties() {
        ...
        assertEquals("dateRange(today(), today().dateAdd(1, \"days\"))", formulaDateProperty.getFormula().getExpression());

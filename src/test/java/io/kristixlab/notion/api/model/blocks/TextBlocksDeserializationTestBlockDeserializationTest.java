...
public class TextBlocksDeserializationTestBlockDeserializationTest extends BaseBlockDeserializationTest {
    ...
    void testParagraphEmpty() {
        ...
        ParagraphBlock p = (ParagraphBlock) b;
        // Block-level
    ...
    void testParagraphWithUserMention() {
        ...
        assertEquals("Krista", rt0.getMention().getUser().getName());
        assertEquals("https://s3-us-west-2.amazonaws.com/public.notion-static.com/c183efb3-3c41-4cdc-a77b-5802f650e997/avatartion_1_y.png", rt0.getMention().getUser().getAvatarUrl());
        ...
        assertFalse(rt0.getAnnotations().isCode());
        assertEquals("default", rt0.getAnnotations().getColor());
        assertEquals("@Krista", rt0.getPlainText());
        assertNull(rt0.getHref());
    ...
    void testParagraphWithDateMention() {
        ...
        assertEquals("ab53e082-c08e-43ef-ae91-62c018852f04", b.getCreatedBy().getId());
        assertEquals("user", b.getLastEditedBy().getObject());
        assertEquals("ab53e082-c08e-43ef-ae91-62c018852f04", b.getLastEditedBy().getId());
    ...
    void testParagraphWithDatabaseMention() {
        ...
        assertEquals("22ec5b96-8ec4-8013-8ecf-ebc71cfc8536", mention.getMention().getDatabase().getId());
        assertNotNull(mention.getAnnotations());
        assertFalse(mention.getAnnotations().isBold());
        assertFalse(mention.getAnnotations().isItalic());
        assertFalse(mention.getAnnotations().isStrikethrough());
    ...
    void testParagraphWithLinkMention() {
        ...
        assertEquals("https://www.airbnb.co.uk/rooms/48823939?check_in=2025-09-12&check_out=2025-09-14&photo_id=1641560102&source_impression_id=p3_1752333984_P3gceXyu0T9HRzYY&previous_page_section_name=1000&_set_bev_on_new_domain=1752333983_EAM2U4MTkxYmVjMT", mention.getMention().getLinkMention().getHref());
        assertEquals("Rental unit in Warsaw · ★4.89 · 1 bedroom · 1 bed · 1 shared bathroom", mention.getMention().getLinkMention().getTitle());
        assertEquals("https://a0.muscache.com/im/pictures/airbnb-platform-assets/AirbnbPlatformAssets-Favicons/original/0d189acb-3f82-4b2c-b95f-ad1d6a803d13.png?im_w=240", mention.getMention().getLinkMention().getIconUrl());
        assertEquals("Great deal! Cheap, nice room in the center of Warsaw", mention.getMention().getLinkMention().getDescription());
        assertEquals("Airbnb", mention.getMention().getLinkMention().getLinkProvider());
        assertEquals("https://a0.muscache.com/im/pictures/airflow/Hosting-48823939/original/f4b99652-c01b-4320-a446-f2e264b5b838.jpg?im_w=720&width=720&quality=70&auto=webp", mention.getMention().getLinkMention().getThumbnailUrl());
        assertNotNull(mention.getAnnotations());
        assertFalse(mention.getAnnotations().isBold());
        assertFalse(mention.getAnnotations().isItalic());
        assertFalse(mention.getAnnotations().isUnderline());
        ...
        assertFalse(mention.getAnnotations().isStrikethrough());
        assertEquals("default", mention.getAnnotations().getColor());
        assertEquals("https://www.airbnb.co.uk/rooms/48823939?check_in=2025-09-12&check_out=2025-09-14&photo_id=1641560102&source_impression_id=p3_1752333984_P3gceXyu0T9HRzYY&previous_page_section_name=1000&_set_bev_on_new_domain=1752333983_EAM2U4MTkxYmVjMT", mention.getPlainText());
        assertEquals("https://www.airbnb.co.uk/rooms/48823939?check_in=2025-09-12&check_out=2025-09-14&photo_id=1641560102&source_impression_id=p3_1752333984_P3gceXyu0T9HRzYY&previous_page_section_name=1000&_set_bev_on_new_domain=1752333983_EAM2U4MTkxYmVjMT", mention.getHref());

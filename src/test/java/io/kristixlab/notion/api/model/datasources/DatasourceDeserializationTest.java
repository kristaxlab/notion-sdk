...
public class DatasourceDeserializationTest extends BaseTest {
  ...
  void testTitleProperty() {
    DatasourceProperty titleProp = dataSource.getProperties().get("Name");
    ...
    TitleDatasourceProperty titleProperty = titleProp.asTitle();
    assertNotNull(titleProperty);
  }

  @Test
  void testRichTextProperty() {
    DatasourceProperty textProp = dataSource.getProperties().get("Text");
    ...
    RichTextDatasourceProperty richTextProperty = textProp.asRichText();
  ...
  void testNumberProperties() {
    ...
    DatasourceProperty numberProp = dataSource.getProperties().get("Number");
    ...
    NumberDatasourceProperty numberProperty = numberProp.asNumber();
    ...
    DatasourceProperty percentProp = dataSource.getProperties().get("Number %");
    assertNotNull(percentProp);
    assertTrue(percentProp.isNumber());
    NumberDatasourceProperty percentProperty = percentProp.asNumber();
    assertEquals("percent", percentProperty.getNumber().getFormat());
  }

  @Test
  void testSelectProperty() {
    DatasourceProperty selectProp = dataSource.getProperties().get("Select");
    ...
    SelectDatasourceProperty selectProperty = selectProp.asSelect();
  ...
  void testMultiSelectProperty() {
    DatasourceProperty multiSelectProp = dataSource.getProperties().get("Multi-select");
    ...
    MultiSelectDatasourceProperty multiSelectProperty = multiSelectProp.asMultiSelect();
  ...
  void testStatusProperty() {
    DatasourceProperty statusProp = dataSource.getProperties().get("Status");
    ...
    StatusDatasourceProperty statusProperty = statusProp.asStatus();
    ...
    StatusDatasourceProperty.StatusOption option1 = statusProperty.getStatus().getOptions().get(0);
    ...
    StatusDatasourceProperty.StatusGroup group1 = statusProperty.getStatus().getGroups().get(0);
  ...
  void testRelationProperties() {
    ...
    DatasourceProperty relationProp = dataSource.getProperties().get("Relation");
    ...
    RelationDatasourceProperty relationProperty = relationProp.asRelation();
    ...
    DatasourceProperty singleRelationProp = dataSource.getProperties().get("one side relation");
    assertNotNull(singleRelationProp);
    RelationDatasourceProperty singleRelationProperty = singleRelationProp.asRelation();
  ...
  void testFormulaProperties() {
    // Test formula number
    DatasourceProperty formulaNumberProp = dataSource.getProperties().get("Formula number");
    ...
    FormulaDatasourceProperty formulaProperty = formulaNumberProp.asFormula();
    ...
    // Test formula date
    DatasourceProperty formulaDateProp = dataSource.getProperties().get("Formula date");
    assertNotNull(formulaDateProp);
    FormulaDatasourceProperty formulaDateProperty = formulaDateProp.asFormula();
    assertEquals(
        "dateRange(today(), today().dateAdd(1, \"days\"))",
        formulaDateProperty.getFormula().getExpression());

    // Test formula boolean
    DatasourceProperty formulaBoolProp = dataSource.getProperties().get("Formula boolean");
    assertNotNull(formulaBoolProp);
    FormulaDatasourceProperty formulaBoolProperty = formulaBoolProp.asFormula();
  ...
  void testRollupProperties() {
    ...
    DatasourceProperty rollupProp = dataSource.getProperties().get("Rollup count unique");
    ...
    RollupDatasourceProperty rollupProperty = rollupProp.asRollup();
    ...
    DatasourceProperty rollupShowProp = dataSource.getProperties().get("Rollup show original");
    assertNotNull(rollupShowProp);
    RollupDatasourceProperty rollupShowProperty = rollupShowProp.asRollup();
  ...
  void testSimpleProperties() {
    // Test checkbox
    DatasourceProperty checkboxProp = dataSource.getProperties().get("Checkbox");
    ...
    // Test email
    DatasourceProperty emailProp = dataSource.getProperties().get("Email");
    ...
    // Test URL
    DatasourceProperty urlProp = dataSource.getProperties().get("URL");
    ...
    // Test phone number
    DatasourceProperty phoneProp = dataSource.getProperties().get("Phone");
    ...
    // Test people
    DatasourceProperty peopleProp = dataSource.getProperties().get("Person");
    ...
    // Test files
    DatasourceProperty filesProp = dataSource.getProperties().get("Files & media");
  ...
  void testAutoGeneratedProperties() {
    // Test created time
    DatasourceProperty createdTimeProp = dataSource.getProperties().get("Created time");
    ...
    DatasourceProperty lastEditedTimeProp = dataSource.getProperties().get("Last edited time");
    ...
    // Test created by
    DatasourceProperty createdByProp = dataSource.getProperties().get("Created by");
    ...
    // Test last edited by
    DatasourceProperty lastEditedByProp = dataSource.getProperties().get("Last edited by");
  ...
  void testSpecialProperties() {
    // Test unique ID
    DatasourceProperty uniqueIdProp = dataSource.getProperties().get("ID");
    ...
    UniqueIdDatasourceProperty uniqueIdProperty = uniqueIdProp.asUniqueId();
    ...
    // Test verification
    DatasourceProperty verificationProp = dataSource.getProperties().get("Verification");
  ...
  void testDateProperties() {
    // Test basic date
    DatasourceProperty dateProp = dataSource.getProperties().get("Date");
    ...
    DateDatasourceProperty dateProperty = dateProp.asDate();
    assertNotNull(dateProperty);
    assertNotNull(dateProperty.getDate());

    // Test date with reminder
    DatasourceProperty dateReminderProp = dataSource.getProperties().get("Date with reminder");

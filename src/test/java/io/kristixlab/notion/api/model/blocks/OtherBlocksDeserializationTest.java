...
class OtherBlocksDeserializationTest extends BaseBlockDeserializationTest {
    ...
    void testBookmark() {
        ...
        BookmarkBlock block = (BookmarkBlock) b;
    ...
    void testBreadcrumb() {
        ...
        BreadcrumbBlock b = (BreadcrumbBlock) block;
        assertEquals("block", b.getObject());
    ...
    void testCalloutWithIcon() {
        ...
        assertEquals("https://www.notion.so/icons/command-line_purple.svg", c.getCallout().getIcon().getExternal().getUrl());
        assertNotNull(c.getCallout().getRichText());
        assertEquals(1, c.getCallout().getRichText().size());
        RichText text = c.getCallout().getRichText().get(0);
        assertEquals("text", text.getType());
    ...
    void testChildDatabase() {
        ...
        ChildDatabaseBlock db = (ChildDatabaseBlock) b;
        ...
        assertFalse(db.isArchived());
        assertFalse(db.isInTrash());
    ...
    void testChildPage() {
        ...
        ChildPageBlock c = (ChildPageBlock) b;
        assertEquals("block", c.getObject());
    ...
    void testColumnList() {
        ...
        ColumnListBlock c = (ColumnListBlock) b;
        assertEquals("block", c.getObject());
    ...
    void testLinkPreview() {
        ...
        LinkPreviewBlock block = (LinkPreviewBlock) b;
        assertNotNull(block.getLinkPreview());
        assertEquals("https://drive.google.com/file/d/1FFcfQqw2OWj2l5zyBSUf5caorWRGvYcO/view?usp=drive_link", block.getLinkPreview().getUrl());
    }
    ...
    void testUnknown() {
        ...
        UnknownBlock b = (UnknownBlock) block;
        assertEquals("block", b.getObject());

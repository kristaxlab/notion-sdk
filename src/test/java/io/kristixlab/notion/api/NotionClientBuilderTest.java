...
import io.kristixlab.notion.api.auth.NotionAuthInterceptor;
import io.kristixlab.notion.api.http.NotionHttpClient;
import io.kristixlab.notion.api.http.NotionVersionInterceptor;
...
class NotionClientBuilderTest {
  ...
  void build_usesCustomRawHttpClient() {
    var customHttpClient =
        new io.kristixlab.notion.api.http.base.client.HttpClient() {
          @Override
          public HttpClient.HttpResponse send(
              io.kristixlab.notion.api.http.base.client.HttpClient.HttpRequest request) {
    ...
    Exception ex =
        assertThrows(
            ...
            () ->
                httpClient.call(
                    "GET",
                    io.kristixlab.notion.api.http.base.request.ApiPath.from("/foo"),
                    String.class));

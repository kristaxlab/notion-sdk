...
class LoggingHttpInterceptorTest {
  ...
  void beforeSend_allBodySubtypes() {
    ...
    for (Body body : bodies) {
      ...
      assertDoesNotThrow(() -> INTERCEPTOR.beforeSend(req), "failed for body: " + body.getClass().getSimpleName());
    }
  }
  ...
  private static List<Body> allBodies() {
    return List.of(
        ...
        new InputStreamBody(new ByteArrayInputStream(new byte[]{1}), 1, "application/octet-stream"),
